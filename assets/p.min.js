...
jQuery(document).ready(function () {
    ...
    $(".bq1").click(function () {
        addAnswer('1', $(this).text())
        $("#q1").fadeOut("slow", function () {
            $("#q2").fadeIn("slow")
        })
    }), $(".bq2").click(function () {
        addAnswer('2', $(this).text())
        $("#q2").fadeOut("slow", function () {
            $("#q3").fadeIn("slow")
        })
    }), $(".bq3").click(function () {
        addAnswer('3', $(this).text())
        $("#q3").fadeOut("slow", function () {
            $("#q4").fadeIn("slow")
        })
    }), $(".bq4").click(function () {
        addAnswer('4', $(this).text())
    ...
    boxRoot = {
        _init: function () {
            setTimeout(function () {
                ...
                e.stopPropagation(), jQuery("#p_modal3").modal("hide"), goToUrlFinish()
                //, stepfinal()
            })
        }
    }, jQuery(document).ready(function () {
